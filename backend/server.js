...
Delivery Date: ${deliveryDate}`,
      ...
      toUser: {
        ...
        text: `Hi ${firstName},\n\nThank you for requesting a quote from X Transport Inc. We have received your shipment details and our team will review them promptly.\n\nWe aim to provide you with a detailed quote within 24 business hours.\n\n— X Transport Inc. Team`,
      },
    });
...
Drug/Alcohol Test Positive (5 years): ${testedPositive}`,
      ...
      toUser: {
        from: config.email.user,
        to: email,
        subject: "Thanks for applying to X Transport Inc.",
        text: `Hi ${firstName},\n\nThank you for applying to join X Transport Inc. as a driver. We have received your application and our recruiting team will review it carefully.\n\nIf your qualifications match our requirements, we will contact you to discuss the next steps in the hiring process.\n\n— X Transport Inc Recruiting Team`,
      },
    });
...
${message}`,
      ...
      toUser: {
        from: config.email.user,
        to: email,
        subject: "Thanks for contacting X Transport Inc.",
        text: `Hi ${name},\n\nThank you for reaching out to X Transport Inc. We've received your message regarding "${subject}" and our team will get back to you as soon as possible.\n\n— X Transport Team`,
      },
    });
